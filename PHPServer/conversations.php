...
$showMoveConversationButton = hasManageConversationsPermission($relationData);
	...
	<div id="conversations-container">
		...
		<div id="message-input">
			<form action="sendmessage.php" method="post" class="message-form" id="formSubmitMessage">
				...
				<textarea autofocus name="messageText" id="messageText" maxlength="40000" placeholder="<?= _("Start a new conversation here...") ?>" class="message-textarea"></textarea>
				</div>
	...
	<div id="modalEdit" class="modal">
		<div class="modal-content">
			...
			<form action="perform_edit_conversation.php" method="post">
				...
				<input type="hidden" name="fromMessages" value="">
