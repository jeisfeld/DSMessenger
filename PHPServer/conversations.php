	...
	<div id="conversations-container">
		...
		<div id="message-input">
			<form action="sendmessage.php" method="post" class="message-form">
				<input type="hidden" name="conversationId" value=""> <input type="hidden" name="relationId"
					value="<?= $relationId ?>"> <input type="hidden" name="contactId" value="<?= $contactId ?>"> <input type="hidden"
					name="isSlave" value="<?= $isSlave ?>"> <input type="hidden" name="subject" value=""> <input type="hidden"
					name="replyPolicy" value="<?= $replyPolicy ?>"> <input type="hidden" name="contactName" value="<?= $contactName ?>">
	...
	<div id="modalDelete" class="modal">
		<div class="modal-content">
			...
			<form action="perform_delete_conversation.php" method="post">
    			...
    			<input type="hidden" name="params" id="modalDeleteParams" value="">
    			<div class="container">
		...
		<div class="modal-content">
			...
			<form action="perform_edit_conversation.php" method="post">
				<input type="hidden" name="conversationId" id="modalEditConversationId" value=""> <input type="hidden"
					name="relationId" id="modalEditRelationId" value=""> <input type="hidden" name="params" id="modalEditParams"
					value="">
				<div class="form-group">
    				<input type="text" name="subject" id="modalEditSubject" value="">
				</div>
				<div class="container">
