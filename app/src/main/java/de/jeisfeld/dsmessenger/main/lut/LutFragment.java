...
import de.jeisfeld.dsmessenger.message.LutMessageDetails.LutMessageType;
...
public class LutFragment extends Fragment {
	 ...
	 */
	private static final String BROADCAST_ACTION = "de.jeisfeld.dsmessenger.main.message.LutFragment";
	/**
	 * The view binding.
	 */
