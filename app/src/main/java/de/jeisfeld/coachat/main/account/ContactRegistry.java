...
import de.jeisfeld.coachat.entity.ConversationDao;
...
public final class ContactRegistry {
	...
	public void remove(final Contact contact) {
		...
		PreferenceUtil.removeIndexedSharedPreference(R.string.key_contact_ai_relation_id, relationId);
		PreferenceUtil.removeIndexedSharedPreference(R.string.key_contact_ai_policy, relationId);
		...
		PreferenceUtil.removeIndexedSharedPreference(R.string.key_contact_ai_priming_id, relationId);
